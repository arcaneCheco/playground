...
export default class Renderer {
  ...
  enableShaderBackground() {
    this.useShaderBackground = true;
    this.instance.autoClear = false;
    this.instance.clear();
    this.gradientCamera = this.experience.gradientCamera;
    this.gradientScene = this.experience.gradientScene;
  }
  ...
  update() {
    ...
    if (this.useShaderBackground) {
      this.instance.render(this.gradientScene, this.gradientCamera);
    }
